%% When switching between Case1~2, need to check 
%% Parameters.m, defineUncerSystem.m and defineSystem.m to make the program working.
...
% Plot test result with one set of validation uncertainty parameters
if SOS.params.err == 0 && CCP.params.err == 0 && DRCCP.params.err == 0
    ...
    Z_sos = dV_sos([vecX;vecY],params.xi_vali);
    ...
    figure(2);
    Z_ccp = dV_ccp([vecX;vecY],params.xi_vali);
    ...
    figure(3);
    Z_drccp = dV_drccp([vecX;vecY],params.xi_vali);
